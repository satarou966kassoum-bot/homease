      ...
      <div className="mt-6 grid gap-10 md:grid-cols-3">
        <div className="md:col-span-2">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <button className="btn-ghost"><Heart size={16} /> Favoris</button>
            <button className="btn-ghost"><Share2 size={16} /> Partager</button>
            <button className="btn-ghost text-clay-500"><Flag size={16} /> Signaler</button>
          </div>
        </div>
        ...
        <aside className="h-fit rounded-lg border border-sand-200 bg-white p-5 shadow-card">
          ...
          <button className="btn-primary mt-5 w-full">Contacter</button>
          {listing.transactionType === "reservation" && (
            <button className="btn-accent mt-3 w-full">Réserver</button>
          )}
          {!user && (
